...
import { Bell, CircleAlert, CircleHelp, CreditCard, LogOut, ShieldAlert, UserRound , SquarePlus} from "lucide-react-native";
...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    fetchUserAdminStatus().then(isAdmin => setIsAdmin(isAdmin));
  }, []);
  ...
  return (
    <>
      <VStack space="lg" backgroundColor="#EFEFEF">
        ...
        >
          <Heading w={"$72"} marginTop={"$4"} fontSize={"$2xl"}>
            Profile
          </Heading>
          ...
          <Text marginTop={"$3"} marginVertical={"$6"} fontWeight={'$semibold'}>
            {" "}
            {email}
          </Text>
        </View>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <SquarePlus size={32} color={"#BFA27E"} />
                <ButtonText
                  fontSize={"$lg"}
                  marginLeft={"$4"}
                  fontWeight="$normal"
        ...
        >
          ...
          >
            ...
            >
              ...
              <ButtonText fontSize={"$lg"} marginLeft={"$4"} color="#BFA27E">
                {" "}
                Logout
              </ButtonText>
              <ButtonIcon
